...
export async function sendPrivateBundle(rawTxHexes: string[], targetBlockNumber?: number) {
  ...
  const result: any = await flashbotsProvider.sendBundle(bundle, blockNumber);
