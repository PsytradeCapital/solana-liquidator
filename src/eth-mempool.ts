...
export function startPendingTxWatcher(onPendingTx: (txHash: string) => Promise<void>) {
...
export async function inspectPendingTx(provider: ethers.providers.Provider, txHash: string) {
